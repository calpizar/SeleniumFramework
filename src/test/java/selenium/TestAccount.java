...
public class TestAccount extends BaseClass {
    ...
    public void Test_Create_New_Account(){
        ...
        String email = "test.user1@test.com"; //registerPage.generateRandomEmail();
    ...
    @Description("Trabajo Final Ejercicio 1: Validate that duplicate email check validation is performed at Register Page")
    @Test
    ...
    @Description("Trabajo Final Ejercicio 1: Validate that random email is generated as expected at Register Page")
    @Test
